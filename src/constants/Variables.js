...
const us_flag = require('../../assets/images/flags/US.png');
const de_flag = require('../../assets/images/flags/DE.png');
const au_flag = require('../../assets/images/flags/AU.png');
const gb_flag = require('../../assets/images/flags/GB.png');
const ro_flag = require('../../assets/images/flags/RO.png');
const br_flag = require('../../assets/images/flags/BR.png');

const tableData = [
  {
    flag: us_flag, country: 'USA', count: '24', percentage: '53%',
  },
  {
    flag: de_flag, country: 'Germany', count: '34', percentage: '12%',
  },
  {
    flag: au_flag, country: 'Australia', count: '434', percentage: '10%',
  },
  {
    flag: gb_flag,
  ...
  {
    flag: ro_flag, country: 'Romania', count: '12', percentage: '5%',
  },
  {
    flag: br_flag, country: 'Brasil', count: '43', percentage: '4%',
  },
];
...
module.exports = {
  ...
  tableData, // For vector map on Dashboard view
